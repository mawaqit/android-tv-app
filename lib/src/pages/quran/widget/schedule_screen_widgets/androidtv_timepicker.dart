...
class _TVFriendlyTimePickerState extends State<TVFriendlyTimePicker> {
      ...
      content: Column(
        ...
        children: [
          Row(
            ...
            children: [
              _buildNumberPicker(
                  _hour, 0, 23, (value) => setState(() => _hour = value)),
              Text(':'),
              _buildNumberPicker(
                  _minute, 0, 59, (value) => setState(() => _minute = value)),
            ],
          ),
        ],
      ),
  ...
  Widget _buildNumberPicker(
      int value, int minValue, int maxValue, Function(int) onChanged) {
    return Column(
      children: [
        IconButton(
