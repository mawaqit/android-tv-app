...
_timesSubscription = timesStream.listen(
  (e) async {
    ...
    if (_lastPrayerScheduleTime != null &&
        now.difference(_lastPrayerScheduleTime!).inHours < 6) {
      logger.i(
    ...
    if (!permissionsGranted) {
      logger.i('Permissions not granted - requesting permissions');
    ...
    if (permissionsGranted) {
      ...
      logger.i('ℹ️ Prayer times will still be displayed, but notifications and auto-toggle won\'t work');
    }
