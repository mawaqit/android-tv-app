...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(mosqueId) =>
      "${mosqueId} എന്നത് ഒരു സാധുവായ മോസ്‌ക് ഐഡി അല്ല";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "afterSalahHadithTitle":
            MessageLookupByLibrary.simpleMessage("പ്രാർത്ഥനയ്ക്കു ശേഷം ദുആ"),
        "alAdhan":
            MessageLookupByLibrary.simpleMessage("പ്രാർത്ഥനയ്ക്കുള്ള വിളി"),
        "alAthkar": MessageLookupByLibrary.simpleMessage("ദിക്ർ"),
        "alIqama": MessageLookupByLibrary.simpleMessage("ഇഖാമത്ത്"),
        "appLang": MessageLookupByLibrary.simpleMessage("ആപ്ലിക്കേഷൻ ഭാഷ"),
        "asr": MessageLookupByLibrary.simpleMessage("അസർ"),
        "backToHomePage":
            MessageLookupByLibrary.simpleMessage("ഹോംപേജിലേക്ക് മടങ്ങുക"),
        ...
        "gpsError": MessageLookupByLibrary.simpleMessage(
            "നിലവിലെ ഉപകരണ ലൊക്കേഷൻ ആക്‌സസ് ചെയ്യാൻ കഴിയുന്നില്ല, നിങ്ങളുടെ ഉപകരണത്തിന്റെ GPS പ്രവർത്തനക്ഷമമാണോയെന്ന് പരിശോധിക്കുക"),
        ...
        "iqamaIn": MessageLookupByLibrary.simpleMessage("ഇഖാമത്ത് ഇനി"),
        "isha": MessageLookupByLibrary.simpleMessage("ഈഷ"),
        "jumua": MessageLookupByLibrary.simpleMessage("ജുമുഅ"),
        "jumuaaHadith": MessageLookupByLibrary.simpleMessage(
            "നബി(സ) പറഞ്ഞു\n \"ആരെങ്കിലും വുദൂ കൃത്യമായി ചെയ്താൽ അവൻ ജുമുഅയിൽ പോയി ശ്രവിക്കുകയും നിശബ്ദത പാലിക്കുകയും ചെയ്യുന്നു.\n ആ സമയത്തിനും അടുത്ത വെള്ളിയാഴ്ചയ്ക്കും മൂന്ന് ദിവസത്തിനുമിടയിലുള്ളത് അവനോട് ക്ഷമിക്കപ്പെട്ടിരിക്കുന്നു\n കല്ലിൽ തൊടുന്നവൻ തീർച്ചയായും വ്യർത്ഥതയുണ്ടാക്കി\""),
        "jumuaaScreenTitle":
            MessageLookupByLibrary.simpleMessage("വെള്ളിയാഴ്ച സമയം"),
        ...
        "maghrib": MessageLookupByLibrary.simpleMessage("മഗ്‌രിബ്"),
        "mawaqitDesc": MessageLookupByLibrary.simpleMessage(
            "പ്രാർത്ഥന സമയം ട്രാക്ക് ചെയ്യാനും നിയന്ത്രിക്കാനും MAWAQIT നിങ്ങൾക്ക് ഒരു പുതിയ മാർഗം വാഗ്ദാനം ചെയ്യുന്നു, 24/24 മണിക്കൂറും ലഭ്യമായ ഒരു ഓൺലൈൻ ടൂൾ മസ്ജിദ് മാനേജർമാർക്ക് നൽകുന്ന ഒരു എൻഡ്-ടു-എൻഡ് സിസ്റ്റം ഞങ്ങൾ വാഗ്ദാനം ചെയ്യുന്നു."),
        "mawaqitWelcome":
            MessageLookupByLibrary.simpleMessage("MAWAQIT-ലേക്ക് സ്വാഗതം"),
        ...
        "mosqueNameError":
            MessageLookupByLibrary.simpleMessage("മസ്ജിദിന്റെ പേര് നൽകുക"),
        "mosqueNoMore":
        ...
        "networkStatus":
            MessageLookupByLibrary.simpleMessage("നെറ്റ്‌വർക്ക് നില"),
